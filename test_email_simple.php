...
echo "=== TESTING SIMPLE EMAIL SERVICE ===\n\n";
...
try {
    $emailService = new App\Services\SimpleEmailService();
...
echo "4. Replace 'your_app_password_here' in SimpleEmailService.php with the actual app password\n";
echo "\n=== TEST COMPLETE ===\n";
